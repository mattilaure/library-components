      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              type = _typeof((0, _isUnique.isUnique)(ranking, props.name));
              currentUser = (0, _isUnique.isUnique)(ranking, props.name);
              if (type === "number") {
                //elemento esiste già
                if (win) {
                ...
                //elemento non esiste
                newObj = (0, _isUnique.isUnique)(ranking, props.name);
                if (win) {
                  newObj.wins++;
                  ranking.push(newObj);
                } else {
              ...
              _context2.next = 5;
              return (0, _storage.setInStorage)(ranking);
            case 5:
            case "end":
